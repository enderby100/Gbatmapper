...
public class MapperPlugin extends BatClientPlugin
    ...
    public void loadPlugin() {
        try {
            System.out.println("BatMapper: Starting plugin load...");
            BASEDIR = this.getBaseDirectory();
            System.out.println("BatMapper: Base directory: " + BASEDIR);

            GuiData guiData = GuiDataPersister.load(BASEDIR);
            System.out.println("BatMapper: GUI data loaded: " + (guiData != null));
            ...
            System.out.println("BatMapper: Tabs created");

            clientWin.setVisible(true);
            System.out.println("BatMapper: Window made visible");
            ...
            System.out.println("BatMapper: Plugin loaded successfully!");
        } catch (Exception e) {
            System.err.println("BatMapper: ERROR loading plugin: " + e.getMessage());
            e.printStackTrace();
        }
    ...
    public void process(Object input) {
        if (input == null) {
            ...
            printConsoleMessage(
                    String.format("\t%s         - to remove label from current room", COMMAND_REMOVE_LABEL));
