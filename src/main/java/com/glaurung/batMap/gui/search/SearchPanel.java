...
public class SearchPanel extends MapperPanel implements ItemListener {
    ...
    public void componentResized(ComponentEvent e) {
        ...
        save.setBounds(20 + searchText.getWidth() + 20 + results.getWidth() + 20 + areaList.getWidth() + 20, 7, 70,
                ELEMENT_HEIGHT);
        this.add(searchText);
        this.add(results);
        this.add(areaList);
    ...
    public List<String> searchForRoomsWith(String text) {
        ...
        // iterate through all areafiles, iterate through all rooms and look for texts,
