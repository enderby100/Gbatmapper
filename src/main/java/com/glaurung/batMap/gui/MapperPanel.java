...
public class MapperPanel extends JPanel implements ComponentListener, DocumentListener, ActionListener {
    ...
    JScrollPane scrollableNotes = new JScrollPane(roomNotes, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
    ...
    public MapperPanel(MapperEngine engine) {
        ...
        descPanel.setBounds(514, BORDERLINE, DESC_WIDTH,
                SHORT_DESC_HEIGHT + LONG_DESC_HEIGHT + EXITS_HEIGHT + 4 * BORDERLINE + BUTTON_HEIGHT * 2);
        ...
        // roomShortDesc.setText("This is an example shortish room descThis is an
        // example shortish room descThis is an example shortish room descThis is an
        // example shortish room desc");
        ...
        // roomLongDesc.setText("Two well-traveled roads cross paths here. One road
        // leads north to a great black castle on a hill. To the west, the road leads to
        // a mountain ridge. Taking the east path will lead you through a forest, and
        // the south path will lead to more familiar areas.\r\n");
        ...
        roomExits.setBounds(0, SHORT_DESC_HEIGHT + BORDERLINE + LONG_DESC_HEIGHT + BORDERLINE, DESC_WIDTH,
                EXITS_HEIGHT);
        ...
        zoomInButton.setBounds(0,
                SHORT_DESC_HEIGHT + BORDERLINE + LONG_DESC_HEIGHT + BORDERLINE + EXITS_HEIGHT + BORDERLINE,
        ...
        roomColor.setBounds(BUTTON_WIDTH + BORDERLINE,
                SHORT_DESC_HEIGHT + BORDERLINE + LONG_DESC_HEIGHT + BORDERLINE + EXITS_HEIGHT + BORDERLINE,
        ...
        saveButton.setBounds(0,
                SHORT_DESC_HEIGHT + BORDERLINE + LONG_DESC_HEIGHT + BORDERLINE + EXITS_HEIGHT + BORDERLINE
                        + BUTTON_HEIGHT + BORDERLINE,
                (int) (BUTTON_WIDTH * 0.7), BUTTON_HEIGHT);
        ...
        reverseExitsButton.setBounds((int) (BUTTON_WIDTH * 0.7) * 3 + (int) (BORDERLINE * 1.5),
                ...
                (int) (BUTTON_WIDTH * 0.7), BUTTON_HEIGHT);
        reverseExitsButton
                .setToolTipText("When adding an exit to new room, also add backwards exit automatically if reversable");
        reverseExitsButton.setSelected(false);
        reverseExitsButton.addActionListener(this);

        // roomNotes.setBounds(0,
        // BORDERLINE+SHORT_DESC_HEIGHT+BORDERLINE+LONG_DESC_HEIGHT+BORDERLINE+EXITS_HEIGHT+BORDERLINE+BUTTON_HEIGHT+BORDERLINE,
        // DESC_WIDTH, NOTES_HEIGHT);
        ...
        scrollableNotes.setBounds(514,
                SHORT_DESC_HEIGHT + BORDERLINE + LONG_DESC_HEIGHT + BORDERLINE + EXITS_HEIGHT + BORDERLINE
                        + BUTTON_HEIGHT + BORDERLINE + BUTTON_HEIGHT + BORDERLINE,
                DESC_WIDTH, descPanel.getHeight() - (4 * BORDERLINE + LONG_DESC_HEIGHT + EXITS_HEIGHT
                        + SHORT_DESC_HEIGHT + BUTTON_HEIGHT + BUTTON_HEIGHT));
    ...
    public void componentResized(ComponentEvent e) {
        ...
        if (visibleDescs) {
            ...
            descPanel.setBounds(this.getWidth() - (7 + DESC_WIDTH), BORDERLINE, DESC_WIDTH,
                    SHORT_DESC_HEIGHT + LONG_DESC_HEIGHT + EXITS_HEIGHT + BUTTON_HEIGHT * 2 + 4 * 7);
            scrollableNotes.setBounds(this.getWidth() - (7 + DESC_WIDTH), BORDERLINE + descPanel.getHeight() + 7,
                    DESC_WIDTH, this.getHeight() - (descPanel.getHeight() + 14 + BORDERLINE));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(roomColor) && e.getModifiers() != 0) {
            ...
            int input = JOptionPane.showConfirmDialog(null,
                    "This will clear ALL data and notes associated with this area. Are you sure?");
